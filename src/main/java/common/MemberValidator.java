 ...
 * 차후 supports(), validate() e두개의 메소드를 오버라이딩 해야한다.
 * */
public class MemberValidator implements Validator{
	...
	public void validate(Object obj, Errors errors) {
		...
		/*
		 supports()
		 	: 매개변수로 전달되는 객체가 유효성 검증을 지원할 수 있는
		...
		/*
		 ...
		 해validate()메소드 내로 진입자체가 불가능하므로, 해당 함수에서
		 "pw"라는 문장은 getter()를 호출하여 지정된 패스워드를
		 얻어온다고 생각하면 된다.
		 */
		...
		if(nameValidate==false) {
			System.out.println("이름이 null입니다. ㅜㅜ");
